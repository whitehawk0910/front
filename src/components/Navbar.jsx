...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      <h1 className='w-full text-3xl font-bold text-[black]'>Byte shield</h1>
      <ul className='hidden md:flex'>
        <li className='p-4'>Home</li>
        <li className='p-4'>harshika</li>
        <li className='p-4'>boos</li>
      ...
      <style jsx>
        {`
          .flex {
            background: linear-gradient(to right, #3498db, #5bc0de); /* Blue to Teal gradient */
          }
        `}
      </style>
    </div>
